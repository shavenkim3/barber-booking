      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
        <div className="text-center lg:text-left">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center lg:justify-start">
            <button className="rounded-full bg-amber-800 px-7 py-3 text-sm font-semibold text-white shadow-md transition hover:bg-amber-900">
              เริ่มจองคิว
            </button>

            <button className="rounded-full border border-stone-300 bg-white px-7 py-3 text-sm font-semibold text-stone-800 transition hover:bg-stone-100">
              ดูบริการทั้งหมด
            </button>
          </div>
          ...
          <div className="mt-12 grid grid-cols-3 gap-4 rounded-3xl border border-stone-200 bg-white p-5 shadow-sm sm:max-w-lg lg:max-w-xl">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-stone-500 sm:text-sm">ช่างมืออาชีพ</p>
            </div>

            <div>
              <h3 className="text-2xl font-bold text-stone-950">4.9</h3>
              <p className="mt-1 text-xs text-stone-500 sm:text-sm">คะแนนรีวิว</p>
            </div>
          </div>
        </div>
